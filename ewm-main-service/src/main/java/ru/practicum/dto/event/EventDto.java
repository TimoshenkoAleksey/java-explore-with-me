...
public class EventDto implements Comparable<EventDto> {
    ...
    public static final Comparator<EventDto> EVENT_DATE_COMPARATOR = Comparator.comparing((EventDto eventDto)
                    -> ExploreDateTimeFormatter.stringToLocalDateTime(eventDto.eventDate))
